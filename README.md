...
2. Creating proxy cds for cross container schema
   
3. Following Artifacts are not currently supported '.hdbreptask'.
   
4. For Virtual table, refer [VirtualTable.md](VirtualTable.md)
